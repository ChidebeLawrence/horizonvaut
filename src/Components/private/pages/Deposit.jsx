...
function Deposite() {
    ...
    const copy = <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            stroke="#656E8B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
        <path
                    ...
                    <div>
                        <div className='px-[20px] pt-[45px] flex gap-[20px] flex-col md:flex-row'>
                            ...
                            <div className='w-full'>
                                ...
                                <Link to="https://www.moonpay.com/buy"
                                      className='flex gap-[7px] items-center bg-[#F8FAFC] border border-[#D0D5DD] rounded-[5px] px-[10px] py-[5px] text-[12px] mt-[12px] text-[#404053] w-fit cursor-pointer text-center'>
                        ...
                        <div className='px-[20px] py-[45px] flex gap-[20px] flex-col md:flex-row'>
                            ...
                            <div className='w-full'>
                                <div>
                                    <p className='text-[#101828] text-[18px] font-semibold'>Deposit into the Crypto Name And Network</p>
                                ...
                                <div className='flex gap-[7px] relative'>
                                    <input
                                        type="text"
                                        value={loadingAddress ? 'Loading Network...' : coinDetails}
                            ...
                            <div className='w-full'>
                                ...
                                {showAddress && (
                                    <div>
                                        ...
                                        <p className='text-[12px] pt pb-[7px] pb-[15px]'>Go to your other wallet and paste the address that you copied or you can scan QR code from your mobile
                                            device</p>
                                        <div className='flex items-center'>
                                            ...
                                            <div className='relative'>
                                                <p onClick={handleCopy}
                                                   className='bg-[#F8FAFC] flex gap-[5px] border border-[#dadada] px-[14px] px-[20px] py-[15px] text-[#444444] font-semibold cursor-pointer rounded-tr-md rounded-br-md'>
                                                    {copy}
                                                    Copy
                                                </p>
                ...
                <div className='relative z-[-1] text-[#667085] flex flex-col gap-[2rem] w-full lg:w-[30%] flex-shrink-[1.2]'>
                    ...
                    <div className='bg-white rounded-md flex flex-col py-[1.5rem] gap-[30px] px-[45px] text-[13px]'>
                        <div>
                            ...
                            <p>Yes, it is safe to do so! To maintain a high level of asset security and flexibility, Horizon Vault uses an industry-standard cold wallet to keep your deposited assets
                                safe, and a hot wallet that allows for all-day withdrawals. All withdrawals undergo a strict confirmation procedure and every withdrawal request is manually reviewed by
                                our team daily at 0:00AM, 8:00AM, and 4:00PM UTC. In addition, 100% of our traders' deposit assets are segregated from Horizon Vault's own operating budget for
                                increased financial accountability. If you wish to learn more, please refer to our Terms of Service.</p>
                        </div>
                        <div>
                            <p className='text-[14px] font-semibold pb-[10px]'>What type of coin deposits does Horizon Vault support?</p>
                            <p>We're constantly working on expanding the types of coin deposits we accept to better suit your needs. Here are the types of coin deposits we currently support: BTC ETH
                                XRP EOS USDT DOGE DOT LTC XLM Note: Each coin must be based and have their transaction hash (TXID) validated on their respective standard blockchains. Depositing a coin
                                type via a blockchain not listed above may result in the permanent loss of your coin.</p>
                        </div>
                        <div>
                            <p className='text-[14px] font-semibold pb-[10px]'>I don't see my deposit in my account. Why?</p>
                            <p>There might be a few reasons for the delay. Here are the major reasons for the respective coins: BTC — Unconfirmed transactions on the blockchain (at least 3
                                confirmation is needed). ETH — Unconfirmed transactions on the blockchain (at least 30 confirmations are needed), or it could be a Smart Contract transaction that
                                Horizon Vault does not currently support. XRP or EOS — Invalid or missing tag/memo when the deposit was made. USDT — Unconfirmed transaction on the blockchain (1 or 30
                                or 100 confirmations are needed depending if the deposit was an Omni, ERC-20, or TRC-20 transfer).</p>
                        </div>
                    </div>
                </div>
            </div>
