            ...
            {userEmail} <FaCaretDown className='text-[20px]'/>
                ...
                {isOpen && (
                    <div className={classNames(
                        ...
                        <div
                            className="mx-[25px] mb-[16px] mt-[32px] flex justify-center items-center bg-[#121212] border border-[#282828] rounded-[5px] w-[full] h-[74px] relative pl-[9px] menu__overview">
                        ...
                        <div className="flex justify-center gap-[10px] w-[full]">
                            <Link to="/profile/deposit" onClick={handleIsOpen}
                                  className="hover:bg-[#2b2d33] flex items-baseline justify-center gap-[5px] inline-block text-sm leading-4 text-white bg-[#23262e] border border-gray-700 rounded-md min-w-[106px] py-3 text-center"
                                  href="@/profile/deposit">
                                <img src={WalletAdd} alt="wallet-add"/>
                                Deposit
                            </Link>
                            <Link to="/profile/withdraw" onClick={handleIsOpen}
                                  className="hover:bg-[#2b2d33] flex baseline-center justify-center gap-[5px] inline-block text-sm leading-4 text-white bg-[#23262e] border border-gray-700 rounded-md min-w-[106px] py-3 text-center"
                        ...
                        <div className='py-[1rem] border-t border-[#2b2d33] border-b border-[#2b2d33]'>
                            ...
                            <ProfileTab wallet_menu={Support} alt="support" to="profile/support"
                                        title={<>Support <span className="bg-redTab text-white text-[10px] py-1 px-2 text-[8px] text-center rounded-[50%] animate-fade">1</span></>}
                ...
                {openMenu ? <IoClose className='h-[25px] w-[25px] cursor-pointer lg:hidden' onClick={handleOpenMenu}/> :
                    <GiHamburgerMenu className='h-[25px] w-[25px] cursor-pointer lg:hidden' onClick={handleOpenMenu}/>}
            </div>
