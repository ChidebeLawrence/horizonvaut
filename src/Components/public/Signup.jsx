  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://api.horizonvaut.com/auth/sign-up",
        requestOptions
      );
      ...
      if (codeFromResponse === 200) {
        setMessageColor(messageColors[messageFromResponse] || "limegreen");
        setName("");
        setEmail("");
        setPassword("");
        setRepeatPassword("");
        ...
        // Setup account
        const accountSetupResponse = await fetch(
          "https://api.horizonvaut.com/auth/account-setup",
          {
            method: "GET",
            headers: {
        ...
        <div className="flex flex-col gap-[1rem] mt-[1rem]">
          ...
          <div className="flex justify-between gap-2">
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                className="border h-[15px] w-[15px]"
                required
              />
              <label className="text-[#78778b]">
